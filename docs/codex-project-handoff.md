...
> Continue development of the Floor Coverings International Operations application in this repository. First read `docs/ui-and-product-readiness-review.md`, `docs/google-workspace-rollout-guide.md`, `docs/meeting-notes-and-otter.md`, and `docs/collaboration-and-sharing.md`. Preserve the current Google Workspace test integration and existing user data. Verify the test suite and build before changing code. The next milestone is the “Now” section of the readiness review: choose and document the production architecture, add Google Workspace OIDC login with domain restrictions, complete CRUD and audit events for clients/leads/projects, and turn tasks/follow-ups into durable records. Work in small tested commits and do not deploy a public version without my approval.
