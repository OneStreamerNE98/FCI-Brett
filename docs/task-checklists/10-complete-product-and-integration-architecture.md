...
KPI-02/#52 and SET-10/#56 are merged source-only and undeployed; migration 0012 is unapplied to Sites. PR #57 is merged source-only and undeployed; broader product decisions and implementation remain open.
