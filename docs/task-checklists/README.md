...
| Production foundation and migration | Developer + Cloud administrator | In progress | Review the portable client/project slice, then build the versioned PostgreSQL foundation after owner inputs are approved. |
