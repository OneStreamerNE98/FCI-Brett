...
Private Sites development version 40 is the latest controlled release. PR #32 merged at `adc79b8`, and that exact deployed commit includes PR #30's semantic-table slice at `aa8ed8f`. Later source through PR #48, documentation reconciliation through PR #50, BE-09 in PR #51, KPI-02 in PR #52, BE-12 in PR #53, OIDC-02/OIDC-03 in PRs #54/#55, SET-10 in PR #56, logo refresh in PR #57, and TRK-02 in PR #66 are merged but undeployed.
