...
- [x] Compose PostgreSQL-backed dashboard, search, project list/exact-project/create, client list/create, lead list/create, project-meeting list/create, and logout source routes with capability, project-scope, CSRF, idempotency, and production-envelope coverage.
