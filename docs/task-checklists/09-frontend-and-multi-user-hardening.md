...
Status: In progress — PR #32 at `adc79b8` is deployed as private Sites development version 40, including PR #30's semantic Settings rules table at `aa8ed8f`; source-only PRs #33/#35/#37/#41/#44 complete actionable lists, Settings extraction/admin gating, Tier-1 KPIs, and guided Workspace setup and are not deployed; later structural and multi-user work remains
