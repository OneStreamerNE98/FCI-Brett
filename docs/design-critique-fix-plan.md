...
Current source-only follow-on: `codex/actionable-lists` is complete in PR #33 for the Overview pipeline, Clients, and Projects. It has not been deployed; SET-01 is the next `FloorOpsApp.tsx` packet from the latest `main`.
