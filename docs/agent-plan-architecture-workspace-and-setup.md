...
**Status:** In progress — `codex/ai07a-task-extraction`, July 24, 2026 (sub-PR a). Source-only and undeployed. Sub-PR b remains blocked until this sub-PR and BE-15/PR #181 are both merged.
