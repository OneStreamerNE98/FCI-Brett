...
**Status:** In progress — `codex/des08d-todays-meetings`, July 24, 2026 (sub-scope d; sub-scope b merged in PR #167; sub-scope c deferred because the current source has no live attention strip or truthful signal/destination, and the removed demo strip used fabricated counts). Guide impact: none.
