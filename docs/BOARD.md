...
| NFIX-24 | FloorOps shell state ownership and major-view code splitting (large; FloorOpsApp queue) | In progress — `codex/nfix24-floorops-shell-splitting` | agent-plan |
