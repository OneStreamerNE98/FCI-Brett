...
7. **Administration and core records:** first build narrow audited administration APIs, then Management → Administration & Access with final-Administrator/session-invalidation safeguards; continue with safe editing/archive, atomic lead conversion, project dates, tasks/follow-ups, file metadata, notes, activity, and concurrent-write protection.
