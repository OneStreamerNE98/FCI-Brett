...
| 11 | `codex/migration-rehearsal` | **Tracking: BE-12 in review in draft PR #53:** format-v2 complete source inventory and six-table bounded import are source-only and unmerged; complete the remaining transform, duplicate, restore, reconciliation, and cutover tooling/evidence contract | Production-owned schema/routes complete; isolated staging execution requires separate approval |
