...
- The development D1 model has 22 product and integration tables; the production PostgreSQL registry now defines 28 application tables plus migration history (29 total), with unapproved operational modules explicitly deferred.
