...
| 12 | `codex/workspace-oidc-sessions` | **Tracking: BE-04 complete in PR #38; OIDC-01 complete in #48; OIDC-02 complete in PR #54; OIDC-03/#55 remains in unmerged draft review.** Employee-login OIDC and secure-session issuance exist in source; live client/configuration and second-user rollout remain disabled | Complete the remaining tests, then recorded staging proof and authorization acceptance before live verification |
