...
- `had_callback` (`integer` boolean, non-null, default `false`) records callback occurrence; and
- `callback_note` (`text`, nullable) stores optional trimmed follow-up context, bounded by the server to 1,000 characters.
