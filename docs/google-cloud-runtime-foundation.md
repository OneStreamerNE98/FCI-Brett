...
- requires every project to include `flooringCategory`, `squareFeet`, and `contractValue`, validates nullable or non-null values against the registered v9 constraints, imports them, reads them back, and includes them in SHA-256 evidence;
