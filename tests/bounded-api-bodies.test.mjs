...
const cases = [
  ...
  {
    name: "launch-checklist attestation",
    method: "PATCH",
    maximumBytes: 4_000,
    error: "Launch-checklist update is too large.",
    invoke: (request) => launchChecklistRoute.PATCH(request),
  },
  {
  ...
  },
  {
    ...
    method: "DELETE",
    maximumBytes: 256,
    error: "The disconnect request is too large.",
    invoke: (request) => googleConnectionRoute.DELETE(request),
  },
  {
