...
export const EXPECTED_RUNTIME_TABLE_ACCESS: readonly ExpectedRuntimeTableAccess[] =
  Object.freeze([
    ...
    runtimeTableAccess("external_identities", ["SELECT", "INSERT"]),
...
export const EXPECTED_RUNTIME_COLUMN_UPDATE_ACCESS: readonly ExpectedRuntimeColumnUpdateAccess[] =
  Object.freeze([
    ...
    runtimeColumnUpdateAccess("google_form_lead_intake_watermarks", [
      "last_processed_row",
      "last_processed_submission_key",
      "last_processed_at",
      "updated_by",
    ]),
    runtimeColumnUpdateAccess("google_form_lead_reviews", [
      "source_row",
      "status",
      "reviewed_by",
      "reviewed_at",
    ...
    runtimeColumnUpdateAccess("external_identities", [
      "email",
      "hosted_domain",
      "email_verified",
