...
export async function ensureWorkspaceSchema() {
  await env.DB.batch([
    ...
    env.DB.prepare("CREATE TABLE IF NOT EXISTS user_preferences (user_email TEXT PRIMARY KEY, display_timezone TEXT NOT NULL DEFAULT 'America/New_York', reply_signature TEXT NOT NULL DEFAULT '', personal_calendar_display INTEGER NOT NULL DEFAULT 1, updated_at INTEGER NOT NULL)"),
