...
variable "cloud_run_jobs" {
  description = "Independent source-definition gates for the production migration and inert outbox-drain jobs. Rehearsal is prohibited in production. A definition never executes a job."
  type = object({
