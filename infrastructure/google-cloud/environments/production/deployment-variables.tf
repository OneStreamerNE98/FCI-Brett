...
variable "cloud_run_jobs" {
  description = "Independent source-definition gate for the production migration job. Rehearsal is prohibited in production. A definition never executes a job."
  type = object({
